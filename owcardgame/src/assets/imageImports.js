...
import baptisteIcon from './heroes/cards/baptiste-icon.webp';
import bastionIcon from './heroes/cards/bastion-icon.webp';
import bobIcon from './heroes/cards/bob-icon.webp';
import hanzoIcon from './heroes/cards/hanzo-icon.webp';
import lucioIcon from './heroes/cards/lucio-icon.webp';
import meiIcon from './heroes/cards/mei-icon.webp';
import mercyIcon from './heroes/cards/mercy-icon.webp';
...
import overviewGif from './overview.gif';
import dvaExample from './dva-example.webp';
import offenceClassIcon from './offence-classicon.webp';
import defenceClassIcon from './defence-classicon.webp';
import tankClassIcon from './tank-classicon.webp';
...
import baptisteUltimate from './audio/baptiste-ultimate.mp3';
import baptisteIntro from './audio/baptiste-intro.mp3';
import baptisteEnter from './audio/baptiste-enter.mp3';
...
import hanzoIntro from './audio/hanzo-intro.mp3';
...
export const abilityAudioFiles = {
    ...
    'baptiste-intro': baptisteIntro,
    'baptiste-enter': baptisteEnter,
    'baptiste-ability1': baptisteAbility1,
...
export const getAudioFile = (audioFileName) => {
    ...
    try {
        return require(`./audio/${audioFileName}.mp3`).default;
    } catch (error) {
        console.log(`No audio file available: ${audioFileName}`);
        return null;
    }
};

// Alternative function that returns a promise for better error handling
export const getAudioFileAsync = async (audioFileName) => {
    try {
        const audioFile = require(`./audio/${audioFileName}.mp3`).default;
        return audioFile;
    } catch (error) {
        console.log(`No audio file available: ${audioFileName}`);
        return null;
